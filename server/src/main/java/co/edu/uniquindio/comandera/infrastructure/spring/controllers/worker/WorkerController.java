package co.edu.uniquindio.comandera.infrastructure.spring.controllers.worker;
...
import co.edu.uniquindio.comandera.application.usecases.worker.UpdateWorkerUseCase;
import co.edu.uniquindio.comandera.application.usecases.worker.CreateWorkerUseCase;
...
//        WorkerResponseDTO updated = new UpdateWorkerUseCase.execute(identification, workerDTO);
...
//        try {
//            WorkerResponseDTO createdWorker = workerR.createWorker(workerDTO);
